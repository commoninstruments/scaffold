...
## Commands
- This repo is docs-first and currently has no root package scripts.
- Verify edits with Markdown review and targeted searches.
- If a future script contract is added, document it here and in `README.md`.
